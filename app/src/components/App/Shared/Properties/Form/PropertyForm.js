...
const PropertyForm = ({ initialData = {}, disabled, onSubmit, label }) => {
    ...
    return (
        <form onSubmit={handleSubmit(handleData)} noValidate={true}>
            ...
            <FormGroup>
                <Label htmlFor="soldOrAvailable">
                    {t("fields.soldOrAvailable")}
                </Label>
                <GenericSelect
                    name="soldOrAvailable"
                    value={values.soldOrAvailable}
                    onChange={handleChange}
                    error={errors.soldOrAvailable}
                    data={soldOrAvailable}
                />
            </FormGroup>
            <FormGroup>
